...
class _TableScreenState extends State<TableScreen> {
  ...
  getTable() async {
    ...
    var uri = Uri.https('api.football-data.org', '/v2/competitions/${widget.code}/standings');

    var response1 = await http.get(uri, headers: {'X-Auth-Token': 'e4c06911610d4282969921e96479154a'});
